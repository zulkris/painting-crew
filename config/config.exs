...
config :painting_crew,
  ecto_repos: [PaintingCrew.Repo],
...
config :painting_crew, PaintingCrewWeb.Endpoint,
  ...
  render_errors: [
    formats: [html: PaintingCrewWeb.ErrorHTML, json: PaintingCrewWeb.ErrorJSON],
    layout: false
  ],
  pubsub_server: PaintingCrew.PubSub,
  live_view: [signing_salt: "6NiqNnoF"]
